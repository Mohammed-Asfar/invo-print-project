...
void main() {
  group('buildSupplierLedger', () {
    test(
      'summarizes purchases, returns, payments, and outstanding balance',
      () {
        ...
        expect(ledger.outstandingBalance, 7000);
        ...
        expect(
          ledger.entries.where(
            (entry) => entry.type == SupplierLedgerEntryType.returnEntry,
          ),
          hasLength(1),
        );
        expect(
...
PurchaseEntry _entry({
  ...
  List<PurchaseReturn> returnHistory = const [],
